...
- [Horoscope API:](https://github.com/amihami/horoscope-api)
A **Spring Boot REST API** that enables users to discover their **sun, moon and rising signs** and receive **daily, weekly and monthly horoscope readings**. Built with Java and Spring Boot, it features layered architecture, robust exception handling and clean RESTful design principles.

- [Trade Capture System:](https://github.com/amihami/trade-capture-system)
...
- Handling **exceptions, flow control and data structures**  
- Developing production-ready applications with **Spring Boot** and **SQL databases**

---

#### 🎯 Career Goals

I’m working towards becoming a **backend developer** who builds reliable, scalable systems and contributes to meaningful, user-focused applications. With my foundation in **project and programme management**, I value clarity, collaboration and continuous improvement.
